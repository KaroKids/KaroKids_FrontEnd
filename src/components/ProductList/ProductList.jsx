    ...
    return (
      ...
      <div className="bg-white">
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:max-w-7xl lg:px-8">
          <h2 className="flex flex-col mb-10 font-medium ">PRODUCTOS DISPONIBLES EN KAROKIDS</h2>

        <div className="flex flex-col sm:flex-row  justify-end items-center space-y-4 sm:space-y-0 sm:space-x-4 pb-4 ">
        <label className='mb-1 sm:mb-0'   htmlFor="ordenarpor">ORDENAR POR:</label>
