...
const Panel = () =>{
    ...
    const stats = [
        { id: 1, name: 'Ordenes de compra', value: `+ ${totalOrdenes ? totalOrdenes :0}`,menu:'Productos', link:'/admin/orders' } ,
        { id: 2, name: 'Clientes registrados', value: `+ ${users.length}` ,menu:'Usuarios', link:'/admin/users' },
        { id: 3, name: 'Productos disponibles', value: `+ ${productos.elementosPaginados?.length * productos?.totalPaginas}`,menu:'Productos', link:'/admin/products' },
      ]
    return (
