...
import boysImg from '../../../public/assets/images/logo-chicos.svg';
import girlsImg from '../../../public/assets/images/logo-chicas.svg';
  ...
  const callouts = [
    {
      ...
      href: '#',
      buttonClass: 'bg-transparent w-60 hover:bg-blue-500 text-blue-700 font-semibold hover:text-white py-2 px-4 border border-blue-500 hover:border-transparent rounded'
    },
    {
      name: 'Niñas',
      ...
      href: '#',
      buttonClass:'bg-transparent  w-60 hover:bg-pink-500 text-pink-700 font-semibold hover:text-white py-2 px-4 border border-pink-500 hover:border-transparent rounded'
    },
